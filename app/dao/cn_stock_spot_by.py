...
class CnStockSpotBuy(Model):
    ...
    netprofit_yoy_ratio = fields.FloatField(source_field='netprofit_yoy_ratio', null=True,description='归属净利润同比增长')
    ...
    class Meta:
        abstract = False
        table = 'cn_stock_spot_buy'
        indexes = ['code','date']  #索引
        table_description = '基本面选股'
